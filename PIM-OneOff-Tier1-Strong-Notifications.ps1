##########################################################################
# Tier1-Strong Script is for higher mid-level, stronger-protected roles. 
# Roles will be configured for 4 (now 10) hour max duration, no standing access, 
# and will require MFA upon activation.
#
# Current Roles (none for now):
...
#$userMemberSettings_activationDuration.Setting = '{"maximumGrantPeriod":"4:00:00","maximumGrantPeriodInMinutes":240,"permanentAssignment":true}' # 4 hours
