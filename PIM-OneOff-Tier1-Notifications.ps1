##########################################################################
# Tier1 Script is for mid-level, moderately-protected roles.  Roles will 
# be configured for 10 hour max duration, no standing access, 
# and will not require approval upon activation or MFA.
#
# Current Roles:
# * Administrator
# * Operator
